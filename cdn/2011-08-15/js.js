...
var cdnurl = ("https:" == document.location.protocol) ? "https://perfectirijillo.com/eljojo.net" : "http://perfectirijillo.com/eljojo.net";

jQuery.preLoadImages(cdnurl+'/yo/yo4.jpg',cdnurl+'/yo/yo3.jpg',cdnurl+'/yo/yo5.jpg');
...
$(function(){
	...
	$("#yo").click(function(){
		yo=yo-1;
		if(yo<3) yo = 6;
		$(this).attr('src', cdnurl+'/yo/yo'+yo+'.jpg')
	});
});
var _gaq = _gaq || [];
...
try {
	reinvigorate.track("47601-c0338022wh");
} catch(err) {}
